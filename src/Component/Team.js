    ...
    <div>
      <div className="container-fluid">
        <div className="row">
          <div className="col-md-3">
            <div className="text-box d-flex flex-column justify-content-between">
              <div className="horizontal-flex">
                ...
                <div>
                  <p className="font-weight-bold mb-0 businesstext">Business Design</p>
          ...
          <div className="col-md-3">
            <div className="text-box">
              ...
              <div className="teamdiv">
                ...
                <img src="/Images/More.png" alt="More" className="moreimg1" />
              </div>
            </div>
          </div>
          <div className="col-md-3">
          ...
          <div className="col-md-6 text-box" style={{ position: "relative", marginLeft: "26px" }}>
